    ...
    def _build_graph(self, inputs):
        ...
        def new_get_variable(v):
            ...
            if not name.endswith('W'):
                ...
                logger.info("Binarizing weight {}".format(name))
                return fw(v)
        ...
        def activate(x):
            return fa(nonlin(x * 0.1) - 0.5) + 0.5
        ...
        with remap_variables(new_get_variable), \
            ...
            logits = (LinearWrap(image)
                      ...
                      .BatchNorm('bn0')
                      .apply(activate)
                      .Conv2D('conv1', 256, 5, padding='SAME')
                      .BatchNorm('bn1')
        ...
        conv_wd_cost = regularize_cost('conv.*/W', l2_regularizer(5e-6), name='conv_regularize_cost')

        add_param_summary(('.*/W', ['histogram', 'rms']))
        self.cost = tf.add_n([cost, wd_cost, conv_wd_cost], name='cost')
